...
public class PlayerController : MonoBehaviour // handles most status checks from the player
{
    ...
    private void CheckCollisions()
    {
        ...
        bool groundHit = Physics2D.CapsuleCast(_collider.bounds.center, _collider.size, _collider.direction, 0, Vector2.down, groundDistanceCheck); // future might need a layer check
        bool ceilingHit = Physics2D.CapsuleCast(_collider.bounds.center, _collider.size, _collider.direction, 0, Vector2.up, groundDistanceCheck);
